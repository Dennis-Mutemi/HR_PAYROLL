...
<div class="page-name 	mb-4">
   <h4 class="m-0"><img :src="'/assets/img/profiles/avatar-14.jpg'" class="mr-1" alt="profile" /> Welcome Admin</h4>
...
<div class="row mb-4">
   <div class="col-xl-6 col-sm-12 col-12">
      <div class="breadcrumb-path ">
         <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html"><img :src="'/assets/img/dash.png'" class="mr-3" alt="breadcrumb" />Home</a></li>
